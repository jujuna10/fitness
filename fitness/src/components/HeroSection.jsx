...
function HeroSection() {
  return (
    <div className='relative w-full top-0'>
        ...
        {/* people images */}
        <div className='absolute top-[35%] left-[10%] flex'>
            <Image src="/men1.jpg" alt="fitness girl" width={2000} height={1000} quality={100} className='w-[50px] h-[45px] rounded-[50%] border-[1px] border-white' />
            <Image src="/men2.jpeg" alt="fitness girl" width={2000} height={1000} quality={100} className='w-[50px] h-[45px] rounded-[50%] border-[1px] border-white translate-x-[-45%]' />
            <Image src="/women1.jpeg" alt="fitness girl" width={2000} height={1000} quality={100} className='w-[50px] h-[45px] rounded-[50%] border-[1px] border-white translate-x-[-90%]' />
            <Image src="/women2.avif" alt="fitness girl" width={2000} height={1000} quality={100} className='w-[50px] h-[45px] rounded-[50%] border-[1px] border-white translate-x-[-135%]' />
        </div>
        {/* text */}
