...
function Features() {
  ...
  return (
    <div className='absolute pl-[2%] pr-[2%] w-full flex flex-col gap-[50px]'>
        {/* title and buttons */}
        ...
        <div className='flex gap-[50px]'>
            {name.map((item,index) => (
                <div key={index} className={`bg-[rgb(24,25,30)] p-[25px] h-[520px] rounded-[50px] flex flex-col gap-[20px] ${index === 2 ? 'translate-y-[-50px]' : ''}`}>
