...
function Prices() {
  ...
  return (
    <div className='mt-[100px] pl-[8%] flex gap-8'>
        {/* first */}
            ...
            <div className='flex flex-col gap-14'>
                {names.map((item,index) => (
                    <div className='flex gap-[200px] justify-around items-start bg-[rgb(24,25,30)] h-[150px] rounded-[50px] p-[20px]'>
                        <p className={`text-yellow-500 font-bold ${prices[index] === prices[0] ? 'w-[150px] bg-yellow-500 text-amber-950 rounded-[50px] p-[18px]' : ''}`}>{prices[index]}</p>
